        ...
        {activeSection === 'home' && (
          <section className="max-w-3xl mx-auto text-center">
            ...
            <p className={`text-lg mb-8 ${darkMode ? 'text-gray-300' : 'text-gray-600'}`}>
              This website was built by AI. Initial template is generated by Claude 3.7 Sonnet, and polished by Qwen2.5-coder:14b using the Continue extension in VS Code. 
            </p>
